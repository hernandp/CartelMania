...
m_topLine(make_unique<BannerLine>(g_defaultTopLineText, g_defaultTopLineText, g_defaultFontFamilyName, FontStyleRegular, make_unique<TextFxSolid>())),
m_bottomLine(make_unique<BannerLine>(g_defaultBottomLineText, g_defaultBottomLineText, g_defaultFontFamilyName, FontStyleRegular, make_unique<TextFxSolid>())),
